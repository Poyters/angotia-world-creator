...
describe("prepareInternalMapData script", () => {
  ...
  it("a lack of terrain.items", () => {
    expect(internalMapData.terrain.items).toBe(undefined);
  });
  ...
  it("a lack of terrain.pics", () => {
    expect(internalMapData.terrain.pics).toBe(undefined);
  });
  ...
  it("has proper description", () => {
    expect(internalMapData.description).toBe(
      "mapa tuzmer, zawiera wiele obiektow"
    );
  });

  it("has proper internalId", () => {
    expect(internalMapData.internalId).toBe(
      "4036b340-0e33-4df4-ab51-2a462e691b2d"
    );
  });
  ...
  it("check out npc matrix", () => {
    ...
    expect(internalMapData.npc.matrix).toEqual(npcMatrix);
  });
  ...
  it("check out decoration matrix", () => {
    ...
    expect(internalMapData.decoration.matrix).toEqual(decorationMatrix);
  });
  ...
  it("check out building matrix", () => {
    ...
    expect(internalMapData.building.matrix).toEqual(buildingMatrix);
  });
  ...
  it("check out passage matrix", () => {
    ...
    expect(internalMapData.passage.matrix).toEqual(passageMatrix);
  });
  ...
  it("check out vertex matrix", () => {
    ...
    expect(internalMapData.vertex.matrix).toEqual(vertexMatrix);
  });
});
