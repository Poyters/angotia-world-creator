...
export const CharValidation: React.FC = () => {
  const charErrors: string[] = useSelector(
  ...
  return (
    <>
      ...
      {charErrors.includes(CharCreationError.minLevel) ? (
        <li>{t("char:validation.minLevel", { min: rules.level.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxLevel) ? (
        <li>{t("char:validation.maxLevel", { max: rules.level.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerLevel) ? (
        <li>{t("char:validation.isIntegerLevel")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minHealth) ? (
        <li>{t("char:validation.minHealth", { min: rules.health.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxHealth) ? (
        <li>{t("char:validation.maxHealth", { max: rules.health.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerHealth) ? (
        <li>{t("char:validation.isIntegerHealth")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minAttack) ? (
        <li>{t("char:validation.minAttack", { min: rules.attack.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxAttack) ? (
        <li>{t("char:validation.maxAttack", { max: rules.attack.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerAttack) ? (
        <li>{t("char:validation.isIntegerAttack")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minDefence) ? (
        <li>{t("char:validation.minDefence", { min: rules.defence.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxDefence) ? (
        <li>{t("char:validation.maxDefence", { max: rules.defence.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerDefence) ? (
        <li>{t("char:validation.isIntegerDefence")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minStrength) ? (
        <li>{t("char:validation.minStrength", { min: rules.strength.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxStrength) ? (
        <li>{t("char:validation.maxStrength", { max: rules.strength.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerStrength) ? (
        <li>{t("char:validation.isIntegerStrength")}</li>
      ) : null}
      ...
      {charErrors.includes(CharCreationError.isIntegerDexterity) ? (
        <li>{t("char:validation.isIntegerDexterity")}</li>
      ) : null}
      ...
      {charErrors.includes(CharCreationError.isIntegerInteligence) ? (
        <li>{t("char:validation.isIntegerInteligence")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minJink) ? (
        <li>{t("char:validation.minJink", { min: rules.jink.min })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.maxJink) ? (
        <li>{t("char:validation.maxJink", { max: rules.jink.max })}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerJink) ? (
        <li>{t("char:validation.isIntegerJink")}</li>
      ) : null}
      ...
      {charErrors.includes(CharCreationError.isIntegerAttackSpeed) ? (
        <li>{t("char:validation.isIntegerAttackSpeed")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.minTimeOfOccuranceMin) ? (
        <li>
          {t("char:validation.minTimeOfOccuranceMin", {
            min: rules.timeOfOccurance.min
          })}
        </li>
      ) : null}
      {charErrors.includes(CharCreationError.maxTimeOfOccuranceMin) ? (
        <li>
          {t("char:validation.maxTimeOfOccuranceMin", {
            max: rules.timeOfOccurance.max
          })}
        </li>
      ) : null}
      ...
      {charErrors.includes(CharCreationError.minMaxTimeOfOccurance) ? (
        <li>{t("char:validation.maxTimeOfOccuranceMax")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerTimeOfOccuranceMin) ? (
        <li>{t("char:validation.isIntegerTimeOfOccuranceMin")}</li>
      ) : null}
      {charErrors.includes(CharCreationError.isIntegerTimeOfOccuranceMax) ? (
        <li>{t("char:validation.isIntegerTimeOfOccuranceMax")}</li>
      ) : null}
