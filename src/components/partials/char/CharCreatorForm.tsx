...
export const CharCreatorForm: React.FC = () => {
  ...
  const isMobAggressive = useSelector(
    (state: IStore) => state.char.isMobAggressive
  );
  const fieldDiameter = useSelector(
    (state: IStore) => state.char.fieldDiameter
  );
  ...
  return (
    <main className="charCreatorFormWrapper">
      <div className="charCreatorFormContentWrapper">
        <div
          role="presentation"
          className="charCreatorFormContentWrapper__decorations"
        ></div>
