    ...
    <>
      {isDialogPopup
        ? ReactDOM.createPortal(
            <EditDialog dialogId={id} isActivePopup={setIsDialogPopup} />,
            document.body
          )
        : null}
      {isPlayerPopup
      ...
      <div
        className={`
          ...
          ${
            connectedDialogs?.includes(`${charConfig.invalidPrefix}${id}`)
              ? "dialog--error"
              : ""
          }
        `}
      ...
      >
        <div className="dialog__npc" onClick={() => setIsDialogPopup(true)}>
          <p>
