...
export const EditPlayerDialog: React.FC<IEditPlayerDialog> = ({
  ...
  const submitHandler = () => {
    ...
    const playerDataId = dialogData.player.findIndex(
      playerDialog => playerDialog.id === playerId
    );
  ...
  return (
    <div className="g-container g-container--popup">
      <div role="alert" className="insertPopup insertPopup--dialog">
        <div className="g-deleteBtn" onClick={() => deleteDialog(playerId)}>
          {t("common:delete")}
        </div>
        <div
        ...
        {dialogErr ? (
          <span className="insertPopup--error">{t("char:dialogs.error")}</span>
        ) : null}
