      ...
      <ul className="menu__content t-paragraph2Light">
        <li className="extended">
          ...
          <nav className="submenu t-paragraph6Light">
            <ul>
              <li>
                <SaveJsonOption moduleType={moduleType} />
              </li>
              <li>
                <Export moduleType={moduleType} />
              </li>
            </ul>
          </nav>
        </li>
        ...
        <li>
          <Link to={`/${routesConfig.help}`}>{t("menu:help")}</Link>
        </li>
        <li>
          <Link to={`/${routesConfig.license}`}>{t("menu:license")}</Link>
        </li>
        <li>
          <Link to={`/${routesConfig.features}`}>{t("menu:features")}</Link>
        </li>
        {moduleType === AppModules.map ? (
          <li>
        ...
        <li className="separator">
          <Link to={`/${routesConfig.home}`}>{t("menu:back")}</Link>
        </li>
        <li>
          <a href={appConfig.exitLink}>{t("menu:exit")}</a>
        </li>
      </ul>
    </nav>
  );
