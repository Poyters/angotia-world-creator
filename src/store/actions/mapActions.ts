...
export const changeMapBlockMatrix = (newMatrix: MapMatrix) => ({
...
export const changeMapPassageMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_PASSAGE_MATRIX",
  newMatrix
});

export const changeMapBuildingMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_BUILDING_MATRIX",
  newMatrix
});

export const changeMapDecorationMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_DECORATION_MATRIX",
  newMatrix
});

export const changeMapTerrainMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_TERRAIN_MATRIX",
  newMatrix
});

export const changeMapNpcMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_NPC_MATRIX",
  newMatrix
});

export const changeMapMobMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_MOB_MATRIX",
  newMatrix
});

export const changeMapSeMatrix = (newMatrix: MapMatrix) => ({
  type: "CHANGE_MAP_SE_MATRIX",
  newMatrix
});

export const changeMapVertexWeightMatrix = (newMatrix: MapMatrix) => ({
...
export const changeInternalImagesData = imagesData => ({
